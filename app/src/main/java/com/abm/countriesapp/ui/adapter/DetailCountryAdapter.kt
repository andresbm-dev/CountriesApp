...
class DetailCountryAdapter(private val borders: List<String>) :
    RecyclerView.Adapter<DetailCountryAdapter.ViewHolder>() {

    class ViewHolder(private val binding: ItemAdapterDetailCountryBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemAdapterDetailCountryBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (borders.isEmpty())
            holder.bind(context.getString(R.string.no_limits))
        else
